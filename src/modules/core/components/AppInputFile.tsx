...
export const AppInputFile: React.FC<AppInputFileProps> = ({ control, name, label, className, labelStrong, preview }) => {
    ...
    const handleDropFile = (e: DragEvent, handleChange: (event: {target: {value: unknown}}) => void ) => {
        e.preventDefault();
        try {
            setDropState('DROP');
            ...
            handleChange({target:{value: fileDrop}});
    ...
    const handleChangeInputFile = (e: ChangeEvent<HTMLInputElement>, handleChange: (event: {target: {value: unknown}}) => void) => {
            ...
            <div className={className}>
                <Controller
                    ...
                    render={(({ field }) => {
                        ...
                        // if (dropState !== 'PREVIEW') {
                        //     const reader = new FileReader();
                        //     reader.onload = () => {
                        //         if (!file) {
                        //             setFile(reader.result);
                        //             setNameFile(field.value.name);
                        //             setDropState('PREVIEW');
                        //         }
                        //     };
